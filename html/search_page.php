...
<body id="main">
    ...
    <select id="job1" name="job1" >
        <option value="0" selected disabled>첫번째여신선택</option>
    ...
    <select id="job2" name="job2">
        <option value="0" selected disabled>두번째여신선택</option>
        <option value="1">유리나</option>
            <option value="2">유리나A</option>
            <option value="3">사이네</option>
            <option value="4">사이네A</option>
...
$sql = "SELECT * FROM furuyonidb2 ORDER BY date DESC";
...
<table id="bob" class="type09" cellspacing="0" cellpadding="1" border="0" width="800" >
  ...
  <?php
    ...
    while($row = mysqli_fetch_assoc($result)) {
        if((int)$megami1 != 0 && (int)$megami2 != 0)
        {
        ...
        elseif((int)$megami1 == 0)
        {
          if(((int)$megami2 == $row["megami1"]  ||  (int)$megami2 == $row["megami2"]) ) 
          {
              echo "<tr>";
              echo '<th><a href="#" onClick = \'Deckcode('.$row["megami1"].','.$row["megami2"].','.$row["deckcode1"].','.$row["deckcode2"].')\'>'  . $row["title"]. "</a></th> <td>" . $row["text"]."</td><th>" . $row["date"]."</th>";
              echo "</tr>";
        ...
        elseif((int)$megami2 == 0)
        {
          if(((int)$megami1 == $row["megami1"]  ||  (int)$megami1 == $row["megami2"]) ) 
          {
              echo "<tr>";
              echo '<th><a href="#" onClick = \'Deckcode('.$row["megami1"].','.$row["megami2"].','.$row["deckcode1"].','.$row["deckcode2"].')\'>'  . $row["title"]. "</a></th> <td>" . $row["text"]."</td><th>" . $row["date"]."</th>";
              echo "</tr>";
